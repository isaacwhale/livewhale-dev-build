          ...
          <div class="saveandshare">
            <h3>
              Share:
				...
				</xphp> <xphp var="profiles_sidebar"/>
        </div>
        <div class="col-sm-9">
          <header class="title">
            <h1>
              <xphp var="profiles_name"/>
            </h1>
          </header>
          <div id="main">
            <div class="profiles_description">
              <xphp var="profiles_description"/>
            </div><xphp var="profiles_body"/>
